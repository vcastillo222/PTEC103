...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $user = $_POST['user'];
    $pass = $_POST['password']; // plain text
    ...
    if ($result && $result->num_rows === 1) {
        ...
        header("Location: peru4prem.php");
        exit();
    } else {
        echo "<div style='color:white; text-align:center; font-size:18px;'>Invalid username or password</div>";
    }
...
<main>
<form class="login" method="POST" action="premium.php">
